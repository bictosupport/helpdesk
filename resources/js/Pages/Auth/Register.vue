        ...
        <div class="px-10 py-12">
          ...
          <div class="mx-auto mt-2 mb-6 w-24 border-b" />
            ...
            <div class="flex flex-wrap p-3">
                ...
                <text-input v-model="form.phone" :error="form.errors.phone" class="pb-8 pr-6 w-full lg:w-1/2" :label="__('Phone')" type="text" autofocus autocapitalize="off" :is_required="true" required />
                ...
                <select-input v-if="!(hidden_fields && hidden_fields.includes('department'))"
...
export default {
  ...
  components: {
    ...
    props: {
        is_demo: Number,
        site_key: String,
        departments: Array,  // Add departments as a prop
    },
  data() {
    return {
        disable_button: true,
      form: this.$inertia.form({
        ...
        password: '',
        confirm_password: '',
        department_id: '',  // Add department_id to form
      }),
    }
  },
  methods: {
