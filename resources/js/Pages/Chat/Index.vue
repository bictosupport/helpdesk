...
<!--                                </div>-->
    ...
    <Link v-for="conversation in conversations.data" :key="conversation.id" :href="route('chat.current', conversation.slug || conversation.id)"
        ...
        <div class="flex-2">
            <div class="w-12 h-12 relative">
                <span class="w-12 h-12 rounded-full mx-auto user_icon" alt="chat-user">
                    {{ conversation.creator?.first_name ? Array.from(conversation.creator.first_name)[0] : '' }}
                </span>
        ...
        <div class="flex-1 px-2">
            ...
            <div class="mt-1" v-if="conversation.creator?.email">
                <small class="text-gray-600">{{ conversation.creator.email }}</small>
            </div>
            <div class="mt-1 truncate w-32" v-if="conversation.title">
                <small class="text-gray-600 text-xs">{{ conversation.title }}</small>
            </div>
        </div>
    ...
    <div v-if="!conversations.data.length" class="flex w-full h-full justify-center items-center text-gray-500">
