...
Route::get('/auth/google/redirect', [AuthenticatedSessionController::class, 'redirect'])
    ->name('auth.google.redirect');
Route::get('/auth/google/callback', [AuthenticatedSessionController::class, 'callback']);
...
Route::delete('logout', [AuthenticatedSessionController::class, 'destroy'])
    ...
    Route::get('/select-department', [AuthenticatedSessionController::class, 'showDepartmentSelection'])->name('select-department');
    Route::post('/save-department', [AuthenticatedSessionController::class, 'saveDepartmentSelection'])->name('save-department');

    Route::get('/enter-phone', [AuthenticatedSessionController::class, 'showEnterPhone'])->name('enter-phone');
    Route::post('/save-phone', [AuthenticatedSessionController::class, 'savePhone'])->name('save-phone');

    Route::get('/select-department-phone', [AuthenticatedSessionController::class, 'showDepartmentPhoneSelection'])->name('select-department-phone');
    Route::post('/save-department-phone', [AuthenticatedSessionController::class, 'saveDepartmentPhone'])->name('save-department-phone');
...
// Dashboard
Route::prefix('dashboard')->middleware(['otp'])->group(function () {


 // Define root (/) route for dashboard.
Route::get('/', [DashboardController::class, 'index'])
->name('dashboard')
->middleware(['auth', 'check.department']);

// Define /dashboard route pointing to the same controller method.
